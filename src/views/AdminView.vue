            ...
            <v-card class="mt-6">
                ...
                <v-form>
                    <v-container>
                        <v-row>
                            ...
                            <v-col>
                                ...
                                ]" prepend-icon="mdi-phone" variant="solo" label="Telefone"
                                    v-mask="'(00) 00000-0000'"></v-text-field>
                            </v-col>
                        </v-row>
                        <v-row>
                            <v-col>
                                ...
                                ]" prepend-icon="mdi-email-outline" variant="solo" label="Email"></v-text-field>
                            </v-col>
                            <v-col>
                    ...
                    <v-card-actions class="bg-secondary">
                        <v-spacer>
                            <v-btn variant="tonal"
                                :prepend-icon="disabled ? 'mdi-circle-edit-outline' : 'mdi-content-save'"
                                @click="disabled ? allowEdit() : putInfo()"
                                :color="disabled ? 'primary' : 'green'">{{ disabled ? 'Editar' : 'Salvar' }}</v-btn>
                        </v-spacer>
                    </v-card-actions>
                </v-form>
            </v-card>
